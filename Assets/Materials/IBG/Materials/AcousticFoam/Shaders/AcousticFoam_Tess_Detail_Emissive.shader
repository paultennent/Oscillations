Shader "IBG/5_0/AcousticFoam/Tess_Detail_Emissive" {

	Properties {
		_Color ("Color", Color) = (1,1,1,1)
		_SparkleColor ("SparkleColor", Color) = (1,1,1,1)
		_RainbowSparkles ("RainbowSparkles", Range(0,1)) = 0
	...
	SubShader {
		...
		void surf (Input IN, inout SurfaceOutputStandard o) {
			...
			o.Emission =  md.r * _SparkleColor * lerp( WorldReflectionVector (IN, o.Normal).r, WorldReflectionVector (IN, o.Normal), _RainbowSparkles);
